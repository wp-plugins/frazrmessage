...
Plugin URI: http://novaforce.org/blog/
...
Author URI: http://klick.novaforce.org/
*/
...
$_opt_frazr_msg = 'st_frazr_msg';
$_opt_frazr_id = 'st_frazr_id';
...
<tr valign="top"> 
<th width="33%" scope="row"><label for="frazr_id"><?php _e('Your frazr username:') ?></label></th> 
<td><input type="text" name="frazr_id" id="frazr_id" value="<?php form_option('st_frazr_id'); ?>"/></td> 
</tr>
<tr valign="top">
...
function _show_frazrmsg_curl_warning() {
	?>
<div class="error">
<h3>Frazr Message needs the php cURL library to be installed</h3>
<p>Frazr Message uses the cURL php library to connect to the frazr website. 
