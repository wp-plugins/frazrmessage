...
3. Delete the `frazr_message.php` from the `/wp-content/plugins/` folder
4. Follow the installation instructions

= Plain Text Output =
Edit your theme by putting in `<?php get_frazr_msg(); ?>` where you like to have the messages to be shown. It a simple plain text message.
